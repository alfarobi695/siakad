...
<div class="card-body login-card-body">
  <p class="login-box-msg">Lupa kata sandi? Tenang, kamu bisa mengatur ulang dengan memasukkan email.</p>
  ...
  <form action="{{ route('cek-email') }}" method="post">
    ...
    <div class="row mb-3">
      <div class="col-12">
        <button type="submit" class="btn btn-primary btn-block">{{ __('Kirim Link Password Reset') }}</button>
      </div>
      <!-- /.col -->
    </div>
